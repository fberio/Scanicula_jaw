...
def systeme(x,k,point):
  out=np.array([0.,0.])
  out[0]=2*(x[0]-point[0])+2*(k[0]+k[2]*x[1]+2*k[3]*x[0]+2*k[5]*x[0]*x[1]+k[6]*x[1]**2+3*k[7]*x[0]**2)*(k[0]*x[0]+k[1]*x[1]+k[2]*x[0]*x[1]+k[3]*x[0]**2+k[4]*x[1]**2+k[5]*x[0]**2*x[1]+k[6]*x[0]*x[1]**2+k[7]*x[0]**3+k[8]*x[1]**3+k[9]-point[2])
